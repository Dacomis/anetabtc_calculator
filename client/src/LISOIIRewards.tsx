...
const LISOII = ({ LISOIIRewards }: any) => {
  return (
    <div className="relative my-2 flex flex-col text-lg text-orange-900 placeholder:text-orange-900/80 lg:p-4">
      <div className="absolute -top-9 left-1/2 z-10 mx-auto flex -translate-x-1/2 -translate-y-1/2 transform flex-col rounded-lg border-orange-300 bg-orange-400/40 px-4 py-1 text-orange-900 shadow-2xl">
      ...
      <fieldset className="mb-4 flex items-center justify-between md:w-96 lg:w-[500px]">
        ...
        <NumberFormat
          ...
          thousandSeparator
          suffix={" cNETA"}
          className="input w-5/12 rounded-lg border border-teal-50 bg-teal-100/75 px-2 text-right focus:border-teal-900 focus:shadow-orange-800/80 focus:outline-none md:w-8/12"
          min={1}
